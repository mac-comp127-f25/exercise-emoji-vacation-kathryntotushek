...
public class Emojis {
    ...
    public static GraphicsGroup createSmileyFace(double size) {
        ...
        Ellipse eye = createEye(size * 0.15, 20, 20);
        eye.setCenter(size * 0.35, size * 0.40);
        group.add(eye);

        Ellipse eyeTwo = createEye(size * 0.15, 20, 20);
        eyeTwo.setCenter(size * 0.65, size * 0.40);
        group.add(eyeTwo);
    ...
    private static Ellipse createEye(double size, double x, double y) {
        Ellipse eye = new Ellipse(x, y, size, size);
